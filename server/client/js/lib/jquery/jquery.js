...
(function(window, undefined) {
  ...
  jQuery
      .extend({
                                  ...
                                  deferred[tuple[1]]
                                      (function() {
                                        ...
                                        if (returned
                                          ...
                                          returned.promise().done(
                                              newDefer.resolve).fail(
                                              newDefer.reject).progress(
                                              newDefer.notify);
                                        } else {
        ...
        when : function(subordinate /* , ..., subordinateN */) {
          ...
          remaining = length !== 1
              || (subordinate && jQuery.isFunction(subordinate.promise)) ? length
              : 0,
  ...
  if (!getSetAttribute) {
    ...
    nodeHook = jQuery.valHooks.button = {
      get : function(elem, name) {
        var ret = elem.getAttributeNode(name);
        return ret
            && (name === "id" || name === "name" || name === "coords" ? ret.value !== ""
      ...
      set : function(elem, value, name) {
        ...
        if (!ret) {
          elem
              .setAttributeNode((ret = elem.ownerDocument.createAttribute(name)));
        }
  ...
  jQuery.each([ "radio", "checkbox" ], function() {
    jQuery.valHooks[this] = jQuery
        .extend(jQuery.valHooks[this],
            {
              set : function(elem, value) {
  ...
  (function(window, undefined) {
    ...
    Sizzle.attr = function(elem, name) {
      ...
      return ((val = elem.getAttributeNode(name)) || elem.getAttribute(name))
          && elem[name] === true ? name : val && val.specified ? val.value
          : null;
    };
    ...
    Expr = Sizzle.selectors = {
      ...
      preFilter : {
        ...
        "CHILD" : function(match) {
           ...
           * xn-component of xn+y argument ([+-]?\d*n|) 5 sign of xn-component 6
    ...
    function matcherFromGroupMatchers(elementMatchers, setMatchers) {
      ...
      var matcherCachedRuns = 0, bySet = setMatchers.length > 0, byElement = elementMatchers.length > 0, superMatcher = function(
        ...
        elems = seed
            || byElement
            && Expr.find["TAG"]("*", expandContext && context.parentNode
                || context),
    ...
    is : function(selector) {
      return !!selector
          ...
          rneedsContext.test(selector) ? jQuery(selector, this.context).index(
              this[0]) >= 0 : jQuery.filter(selector, this).length > 0 : this
            ...
            if (elem || elem === 0) {
              ...
              if (jQuery.type(elem) === "object") {
                ...
                if (!jQuery.support.leadingWhitespace
                  ...
                  nodes.push(context.createTextNode(rleadingWhitespace
                      .exec(elem)[0]));
                }
              ...
              get : function(elem, computed, extra) {
                if (computed) {
                  ...
                  return elem.offsetWidth === 0
                      && rdisplayswap.test(jQuery.css(elem, "display")) ? jQuery
   ...
   * transport - AFTER param serialization (s.data is a string if s.processData
   * is true) 3) key is the dataType 4) the catchall symbol "*" can be used 5)
  ...
  function addToPrefiltersOrTransports(structure) {
    ...
    return function(dataTypeExpression, func) {
      ...
      var dataType, i = 0, dataTypes = dataTypeExpression.toLowerCase().match(
          core_rnotwhite)
          || [];
  ...
  function Animation(elem, properties, options) {
    ...
    return animation.progress(animation.opts.progress).done(
        animation.opts.done, animation.opts.complete).fail(animation.opts.fail)
      ...
      .extend({
        ...
        animate : function(prop, speed, easing, callback) {
          var empty = jQuery.isEmptyObject(prop), optall = jQuery.speed(speed,
              easing, callback), doAnimation = function() {
          ...
          return this
              .each(function() {
                var index, data = jQuery._data(this), queue = data[type
                    + "queue"], hooks = data[type + "queueHooks"], timers = jQuery.timers, length = queue ? queue.length
                    : 0;
                      ...
                      jQuery.fn[funcName] = function(margin, value) {
                        ...
                        return jQuery.access(this, function(elem, type, value) {
                          ...
                          if (jQuery.isWindow(elem)) {
                            ...
                            // for Mobile Safari, but there
                            // isn't a whole lot we can do. See pull request at
                            // this URL for discussion:
                          ...
                          if (elem.nodeType === 9) {
                            ...
                            // unfortunately, this causes bug #3838 in IE6/8
                            // only, but there is currently no good, small way
                            // to fix it.
